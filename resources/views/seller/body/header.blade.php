 ...
 <header class="header_area">
    ...
    <ul class="header_menu">
        <li><div class="text-white mt-3">{{ Auth::guard('seller')->user()->name }}</div></li>
        ...
        <li><a data-toggle="dropdown" href="#"><i class="far fa-user"></i></a>
                <div class="user_item dropdown-menu dropdown-menu-right">
                    ...
                    <div>
                        <div class="text-center"><small>{{ Auth::guard('seller')->user()->name }}<br>{{ Auth::guard('seller')->user()->email }}</small></div>
                    </div>
                <ul>
