...
<head>
  <meta charset="utf-8">
    ...
    <title>AsBeez Seller Log in </title>
					...
					<div class="col-lg-4 col-md-5 col-12">
						...
						<div class="p-30 rounded30 box-shadowed b-2 b-dashed">
							<form action="{{ route('seller.login') }}" method="post">
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="email" name="email" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Email Address">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
							...
							<div class="text-center">
								<p class="mt-15 mb-0 text-white">Don't have an account? <a href="{{ route('seller_register') }}" class="text-white ml-5">Sign Up</a></p>
							</div>
						</div>
					</div>
				</div>
