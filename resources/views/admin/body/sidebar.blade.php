  ...
  <aside class="main-sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">  
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
		    ...
		    <li>
          <a href="{{ route('admin_logout') }}"><i data-feather="lock"></i><span>Log Out</span></a>
        </li> 
	...
	<div class="sidebar-footer">
		...
		<!-- item-->
		<a href="{{ route('admin_logout') }}" class="link" data-toggle="tooltip" title="" data-original-title="Logout"><i class="ti-lock"></i></a>
	</div>
  </aside>